...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, MDPIoU=False, eps=1e-7):
    # Get the coordinates of bounding boxes
    ...
    # IoU
    iou = inter / union
    if CIoU or DIoU or GIoU or MDPIoU:
        ...
        if CIoU or DIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            return iou - ((d12+d22)/(cw2+ ch2))  # MPDIoU
